...
const ListsBaseModelSchema = Schema(
  name: r'ListsBaseModel',
  id: 8909564818450385142,
  properties: {
    ...
    r'type': PropertySchema(
      ...
      name: r'type',
      type: IsarType.byte,
      enumMap: _ListsBaseModeltypeEnumValueMap,
    ),
  ...
  estimateSize: _listsBaseModelEstimateSize,
  serialize: _listsBaseModelSerialize,
  deserialize: _listsBaseModelDeserialize,
  deserializeProp: _listsBaseModelDeserializeProp,
);

int _listsBaseModelEstimateSize(
  ListsBaseModel object,
  List<int> offsets,
...
ListsBaseModel _listsBaseModelDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = ListsBaseModel();
  ...
  object.releaseDate = reader.readStringOrNull(offsets[5]);
  object.title = reader.readStringOrNull(offsets[6]);
  object.type =
      _ListsBaseModeltypeValueEnumMap[reader.readByteOrNull(offsets[7])] ??
          BaseModelType.movie;
  object.voteAverage = reader.readDoubleOrNull(offsets[8]);
  return object;
}

P _listsBaseModelDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
  ...
  switch (propertyId) {
    ...
    case 6:
      return (reader.readStringOrNull(offset)) as P;
    case 7:
      return (_ListsBaseModeltypeValueEnumMap[reader.readByteOrNull(offset)] ??
          BaseModelType.movie) as P;
    case 8:
...
const _ListsBaseModeltypeEnumValueMap = {
  'movie': 0,
  'tv': 1,
  'people': 2,
};
const _ListsBaseModeltypeValueEnumMap = {
  0: BaseModelType.movie,
  1: BaseModelType.tv,
  2: BaseModelType.people,
};

extension ListsBaseModelQueryFilter
    on QueryBuilder<ListsBaseModel, ListsBaseModel, QFilterCondition> {
  QueryBuilder<ListsBaseModel, ListsBaseModel, QAfterFilterCondition>
      backdropPathIsNull() {
  ...
  QueryBuilder<ListsBaseModel, ListsBaseModel, QAfterFilterCondition> idEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
  ...
  QueryBuilder<ListsBaseModel, ListsBaseModel, QAfterFilterCondition> idBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ListsBaseModel, ListsBaseModel, QAfterFilterCondition>
      typeEqualTo(BaseModelType value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'type',
        value: value,
...
extension ListsBaseModelQueryObject
    on QueryBuilder<ListsBaseModel, ListsBaseModel, QFilterCondition> {}
